 ...
 * @Author: chengling.bj
 * @Description: 将附件拼成table 作为 内容
 */
public class Excel2Html {

  /**
   * @param filePath    excel源文件文件的路径
   * @param content     表格以外的数据
   * @param isWithStyle 是否需要表格样式 包含 字体 颜色 边框 对齐方式
   */
  public static String readExcelToHtml(String filePath, String content, boolean isWithStyle) {
  ...
  ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//  private static <T> String getCellValue(Cell cell, List<T> list, int rowIndex, int colIndex) throws Exception{
//    String result = "";
...
//          Excel excel = fields[colIndex].getAnnotation(Excel.class);
//          Date date = (Date)fields[colIndex].get(list.get(rowIndex-1));
//          result = sdf.format(date);
//        } else if (cell.getCellStyle().getDataFormat() == 58) {
//          // 处理自定义日期格式：m月d日(通过判断单元格的格式id解决，id的值是58)
//          SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
